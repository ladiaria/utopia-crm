...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'price', 'active', 'type', 'weekday', 'slug', 'bundle_product', 'billing_priority')
    list_editable = ['name', 'type', 'price', 'weekday', 'bundle_product', 'billing_priority']
